...
public interface CustomerServiceConstants {
	
	static final String CUSTOMER_ADDED_SUCCESS = "Customer created successfully";
	static final String CUSTOMER_ADDED_FAILED = "customer creation failed";
